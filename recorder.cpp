			...
			if(camera_id == 3){
				...
				if(value1 == (16 * size1)){ // 16 is no signal pixel
					...
					if(l_recorder_camera3_id == -1){
						if(value1 > (16 * size1)) //Aging시 오동작이 발생하여 밝기가 확실한 경우만 2Ch로 전환
							Video3OkCnt++;
						else
							Video3OkCnt = 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(l_sys_setup.cfg.iVideoQuality == CFG_VIDEO_QUALITY_MIDDLE){
		...
		parameters["channel1-h264-min-qp"] = "34";  //35는 화질이 별로라 34로 Fix
...
//	ui::previewShowCameraStream(preview1, 1, false);
	...
	////++}*************************************************************
#if 1//ndef TARGET_CPU_V536		//??? Segmentation fault	//후방 노화가 안됨
	if(l_recorder_camera2_id >= 0){
